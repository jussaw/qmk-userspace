...
[_ADJUST] = LAYOUT_planck_grid(
    QK_BOOT,   DF(_QWERTY),XXXXXXX, XXXXXXX, XXXXXXX, TG(_GAME),KC_MPLY, KC_MPRV, KC_MNXT,  XXXXXXX, XXXXXXX, XXXXXXX,
    UG_TOGG, XXXXXXX,    XXXXXXX, MS_BTN2, MS_BTN1, XXXXXXX,  KC_VOLU, MS_LEFT, MS_DOWN,  MS_UP, MS_RGHT, XXXXXXX,
    UG_NEXT, XXXXXXX,    XXXXXXX, MS_BTN4, MS_BTN5, XXXXXXX,  KC_VOLD, MS_WHLL, MS_WHLD,  MS_WHLU, MS_WHLR, XXXXXXX,
